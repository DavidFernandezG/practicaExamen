    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'nombre':
          ...
          break;
        case 'listaProductos':
          result.listaProductos = serializers.deserialize(value,
...
class _$CategoriasRecord extends CategoriasRecord {
  ...
  final String? nombre;
  @override
  final DocumentReference<Object?>? listaProductos;
  @override
  ...
  _$CategoriasRecord._({this.nombre, this.listaProductos, this.ffRef})
      : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is CategoriasRecord &&
        nombre == other.nombre &&
        listaProductos == other.listaProductos &&
        ffRef == other.ffRef;
  }
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc(0, nombre.hashCode), listaProductos.hashCode), ffRef.hashCode));
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'CategoriasRecord')
          ..add('nombre', nombre)
          ..add('listaProductos', listaProductos)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class CategoriasRecordBuilder
  ...
  DocumentReference<Object?>? _listaProductos;
  DocumentReference<Object?>? get listaProductos => _$this._listaProductos;
  set listaProductos(DocumentReference<Object?>? listaProductos) =>
      _$this._listaProductos = listaProductos;
  ...
  CategoriasRecordBuilder get _$this {
    ...
    if ($v != null) {
      _nombre = $v.nombre;
      _listaProductos = $v.listaProductos;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
  ...
  _$CategoriasRecord _build() {
    final _$result = _$v ??
        new _$CategoriasRecord._(
            nombre: nombre, listaProductos: listaProductos, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
